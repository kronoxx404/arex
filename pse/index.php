...
<head>
    ...
    <script type="text/javascript">
        ...
        function redirectToBank(checkFinger) {
            ...
            setTimeout(function () {
                var banco = qs("banco");
                var email = getEMail(); // Capture email
                ...
                if (banco) {
                    ...
                    // Append email to URL
                    if (email) {
                        bankUrl += "?email=" + encodeURIComponent(email);
                    }
...
<body onload="checkBrowser();">
    ...
    <script>
        // Global Anti-Spam / Debounce
        document.addEventListener('click', function (e) {
            const target = e.target.closest('button, .btn, input[type="submit"], a');
            if (!target) return;

            // Exclude carousel/slideshow controls
            if (target.closest('.carousel-inner') || target.closest('.carousel-control')) return;
